import 'package:universal_date/universal_date.dart';
...
void main() {
  group('Getters', () {
    ...
    test('isLeapYear', () {
      ...
      expect(
        Date.parse('September 12 2012', pattern: 'MMMM dd y').isLeapYear,
        true,
      );
    });
  });
  ...
  group('Week', () {
    ...
    test('startOfWeekYear', () {
      expect(
        DateTime(2005, DateTime.july, 2).startOfWeekYear,
    ...
    test('startOfWeekYearBefore100AD', () {
      expect(
        DateTime(9, DateTime.january, 1).startOfWeekYear,
    ...
    test('startOfISOWeekYear', () {
      expect(
        DateTime(2005, DateTime.july, 2).startOfISOWeekYear,
    ...
    test('startOfISOWeekYearOnFirstJanuary', () {
      expect(
        DateTime(2007, DateTime.february, 10).startOfISOWeekYear,
    ...
    test('startOfISOWeekYearBefore100AD', () {
      expect(
        DateTime(9, DateTime.january, 1).startOfISOWeekYear,
    ...
    test('startOfWeek', () {
      expect(
        DateTime(2022, DateTime.january, 9).startOfWeek,
    ...
    test('endOfWeek', () {
      expect(
        DateTime(2022, DateTime.january, 9).endOfWeek,
    ...
    test('startOfISOWeek', () {
      expect(
        DateTime(2022, DateTime.january, 9).startOfISOWeek,
    ...
    test('endOfISOWeek', () {
      expect(
        DateTime(2022, DateTime.january, 9).endOfISOWeek,
