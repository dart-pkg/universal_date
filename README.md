# universal_date
[![Pub](https://img.shields.io/pub/v/universal_date.svg)](https://pub.dartlang.org/packages/universal_date)

Dart Extensions for `DateTime`

universal_date provides the most comprehensive, yet simple and consistent toolset for manipulating Dart dates.
...
[Check full docs](https://pub.dev/documentation/universal_date/latest/)
